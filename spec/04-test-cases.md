...
## Trading calendar & how-it-works (docs 11–12)

**TC-CAL-01** — CAL-01→05/07 tags, tiers, enforcement (v1.71)
```gherkin
...
**TC-DOC-01** — DOC-01→05/UI-29 guide integrity (v1.71)
```gherkin
...
| ENT-11 / CLS-08 / ORD-12/12a / OWN-03a / NFR-07a/08/09/09a/10/11/11a/12 / TPF-03b(i)(ii) | TC-ENT-11 | | ORD-10/11 | TC-RPT-17, TC-RPT-22 | | OWN-12 | TC-OWN-12 |
