...
**v1.89 (operator-commissioned 2026-07-15; current through spec v1.89).** A complete, non-technical
...
# THE GUIDE (ratified content, v1.89 — describes spec v1.89; DOC-05 stamp)
...
# GETTING STARTED (ratified content, v1.89 — describes spec v1.89 and the build's true run procedure; DOC-05 stamp)
