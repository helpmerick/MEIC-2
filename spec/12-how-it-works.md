...
**v2.06 (operator-commissioned 2026-07-15; current through spec v2.06).** A complete, non-technical
...
# THE GUIDE (ratified content, v2.06 — describes spec v2.06; DOC-05 stamp)
...
# GETTING STARTED (ratified content, v2.06 — describes spec v2.06 and the build's true run procedure; DOC-05 stamp)
