...
**v2.07 (operator-commissioned 2026-07-15; current through spec v2.07).** A complete, non-technical
...
# THE GUIDE (ratified content, v2.07 — describes spec v2.07; DOC-05 stamp)
...
# GETTING STARTED (ratified content, v2.07 — describes spec v2.07 and the build's true run procedure; DOC-05 stamp)
